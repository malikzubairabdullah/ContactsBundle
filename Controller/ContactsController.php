...
use Zubair\ContactsBundle\Entity\Employee;
use Zubair\ContactsBundle\Entity\EmployeeContacts;
use Zubair\ContactsBundle\Entity\Designation;
use Zubair\ContactsBundle\Form\Type\EmployeeType;
use Zubair\ContactsBundle\Form\Type\EmployeeContactsType;
use Zubair\ContactsBundle\Form\Type\BulkUploadType;
use Zubair\ContactsBundle\Form\Type\DesignationType;
...
class ContactsController extends Controller
{
    ...
    public function detailsAction(Request $request,$id){
        ...
        $entity = $em->getRepository("ZubairContactsBundle:Employee")->findAll();
        $outputArray = array();
        ...
        foreach($entity as $obj){
            if($obj->getId() == $id){
                ...
                //$office = $em->getRepository("ZubairOrganizationBundle:Office")->find($obj->getId());
                $email = $em->getRepository("ZubairContactsBundle:EmployeeEmail")->findAll();
                $contact = $em->getRepository("ZubairContactsBundle:EmployeeContacts")->findAll();
                $array['id']    = $obj->getId();
    ...
    public function editAction($id, Request $request) {
        ...
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('ZubairContactsBundle:Employee')->findOneBy(array('id' => $id));
    ...
    public function removeContactAction($id) {
        ...
        $entity = $em->getRepository("ZubairContactsBundle:Employee")->find($id);
        if (!$entity) {
        ...
        foreach ($email as $emails) {
            if($emails->getEmployee()->getId() == $id){
                ...
                $entityemail = $em->getRepository("ZubairContactsBundle:EmployeeEmail")->find($emails->getId());
                $em->remove($entityemail);
            }
        }
        foreach ($contact as $contacts) {
            if($contacts->getEmployee()->getId() == $id){
                $entitycontact = $em->getRepository("ZubairContactsBundle:EmployeeContacts")->find($contacts->getId());
    ...
    public function bulkAction(Request $request){
        $form = $this->createForm(new \Zubair\UserBundle\Form\BulkUploadType());
        $form->handleRequest($request);
        $message = '';
    ...
    public function editDesignationAction(Request $request, $id){
        $em = $this->getDoctrine()->getManager();
        $entity = $em->getRepository('ZubairContactsBundle:Designation')->findOneBy(array('id' => $id));
        $form = $this->createForm(new DesignationType(), $entity);
    ...
    public function removeDesignationAction(Request $request, $id){
        ...
        $entity = $em->getRepository("ZubairContactsBundle:Designation")->find($id);
        if (!$entity) {
