...
namespace Zubair\ContactsBundle\Form\Type;
...
class EmployeeType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('designation', 'entity', array(
            'class' => 'ZubairContactsBundle:Designation',
            'property' => 'name',
            'label' => false,
            'attr' => array(
                'class' => 'form-control'
        ...
        $builder->add('office', 'entity', array(
            'class' => 'ZubairOrganizationBundle:Office',
            'property' => 'name',
            'label' => false,
            'attr' => array(
                'class' => 'form-control'
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver) {
        $resolver->setDefaults(array(
            'data_class' => 'Zubair\ContactsBundle\Entity\Employee',
        ));
    }
