...
namespace Zubair\ContactsBundle\Entity;
...
use Zubair\OrganizationBundle\Entity\Office;
use Zubair\OrganizationBundle\Entity\Organization;

/**
 * @ORM\Entity
 * @ORM\Table(name="employee")
 * @ORM\Entity(repositoryClass="Zubair\ContactsBundle\Entity\Repository\EmployeeRepository")
 */
class Employee
{
    /**
    ...
    /**
     * @ManyToOne(targetEntity="Zubair\OrganizationBundle\Entity\Office")
     * @JoinColumn(name="office_id", referencedColumnName="id")
     **/
    private $office;

    /**
     * @ORM\ManyToOne(targetEntity="Zubair\OrganizationBundle\Entity\Organization", inversedBy="employees")
